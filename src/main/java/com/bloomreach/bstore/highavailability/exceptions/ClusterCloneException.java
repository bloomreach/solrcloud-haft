...
/**
 * Exception to  indicate that there was a cluster Clone Exception
 *
 * @author nitin
 * @since 6/26/2015
 */
public class ClusterCloneException extends Exception {
   ...
   * @param message
   */
  public ClusterCloneException(String message) {
    super(message);
  }
