...
import com.bloomreach.bstore.highavailability.actions.*;
 ...
 * @since 06/02/2014
 */
public class SolrCloudCrossClusterBackup {
  protected static final Logger logger = Logger.getLogger(SolrCloudCrossClusterBackup.class);
  ...
  public static void main(String[] args) throws Exception {
    ...
    try {
      ...
      logger.info("Streaming Successful from " + sourceZk + " cluster to " + destinationZookeeper + " Solr Cluster");
    } catch (Exception e) {
